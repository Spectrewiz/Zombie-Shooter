...
namespace ZombieShooter
{
    class pathFinder
    {
        ...
        {
            bool[,] cMap = new bool[Convert.ToInt16(Game.stage.Height / pathFinder.gridSize),
                 Convert.ToInt16(Game.stage.Width / pathFinder.gridSize)];
            ...
            for (int r = 0; r < cMap.GetLength(0); r++)
            {
                ...
                for (int c = 0; c < cMap.GetLength(1); c++)
                {
                    ...
                    {
                        if (o.area.Intersects(rec) && o.alive && o.Solid && !objEx.Contains<Obj>(o)) { cMap[r, c] = false; break; } else { cMap[r, c] = true; }
